...
<x-app-layout>
  ...
  <div class="mb-3 flex flex-wrap items-stretch gap-3 backdrop-blur-sm bg-white/60 rounded-xl p-2">

    {{-- ซ้าย: สรุปเส้นทาง --}}
    <div class="flex-1 rounded-xl border bg-white p-4 shadow-sm min-w-[280px]">
    ...
    <div class="flex-1 rounded-xl border bg-white p-4 shadow-sm min-w-[300px]">
      ...
      <div class="mt-2 flex items-start gap-3">
        ...
        <div class="min-w-0">
          <div id="navInstructionText" class="text-sm font-semibold text-slate-700 truncate">
            กำลังคำนวณเส้นทาง...
          </div>
          <div id="navInstructionMeta" class="text-xs text-slate-500 truncate"></div>
        </div>
      </div>
    </div>
